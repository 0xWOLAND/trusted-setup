...
`;
  ...
  var drawAccelerationLocation = gl.getUniformLocation(
    program,
    "u_acceleration"
  );
  ...
  function render() {
    ...
    var destinationTransformFeedback =
      particleTransformFeedbacks[destinationIdx];

    gl.bindVertexArray(sourceVAO);

    gl.bindTransformFeedback(
      gl.TRANSFORM_FEEDBACK,
      destinationTransformFeedback
    );
    gl.bindBufferBase(
      gl.TRANSFORM_FEEDBACK_BUFFER,
      0,
